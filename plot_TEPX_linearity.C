  ...
  for (int pu = 0; pu < pulist.size(); pu++) {
    ...
    for (int pu = 0; pu < pulist.size(); pu++) {
		...
		char *Projection12 = new char[10];
      		Int_t pro13 = d + 1;
      		sprintf(Projection12,"ProjectionssRing1_%d.gif",pro13);
		...
		char *Projection14 = new char[10];
      		Int_t pro14 = d + 1;
      		sprintf(Projection14,"ProjectionssRing2_%d.gif",pro14);
      		cout<<"=========================="<<Projection14<<endl;
		...
		char *Projection15 = new char[10];
      		Int_t pro15 = d + 1;
      		sprintf(Projection15,"ProjectionssRing3_%d.gif",pro15);
      		cout<<"=========================="<<Projection15<<endl;
		...
		char *Projection16 = new char[10];
      		Int_t pro16 = d + 1;
      		sprintf(Projection16,"ProjectionssRing4_%d.gif",pro16);
      		cout<<"=========================="<<Projection16<<endl;
		...
		char *Projection17 = new char[10];
      		Int_t pro17 = d + 1;
      		sprintf(Projection17,"ProjectionssRing5_%d.gif",pro17);
      		cout<<"=========================="<<Projection17<<endl;
		...
		char *Projection17 = new char[10];
            ...
            if (option == 3){
            //draw the 2D 3x Coincidences distributions for all PU
            TString histoname = "BRIL_IT_Analysis/TEPX/3xCoincidences/Number of 3x Coincidences for Disk ";
            TH2F* H = (TH2F*)F.Get(histoname + disklist[d].c_str());
	    Histogram2D[pu][d] = (TH2F*)H->Clone(TString(H->GetName()));
            ProjectionY[pu][d] = (TH1D*)H->ProjectionY()->Clone(TString(H->GetName()) + "Projection");
            Prof_TEPXClustersPerEvent[pu][d] = (TProfile*)H->ProfileX()->Clone(TString(H->GetName()) + "Profile"); //number of cluster vs ring

		if (pu < 4){
	        TCanvas *c15 = new TCanvas();
            	c15->cd();
                Histogram2D[pu][d]->GetYaxis()->SetRangeUser(0, 20);
      		Histogram2D[pu][d]->Draw("colz");
      		char *hist2Dname11 = new char[10];
      		Int_t pud = pu * 8 + d + 1;
      		sprintf(hist2Dname11,"histoss2D_%d.gif",pud);
      		cout<<"=========================="<<hist2Dname11<<endl;
      		c15->Print(outputpath + hist2Dname11);
      		c15->Clear();
                
                TCanvas *c16 = new TCanvas();
            	c16->cd();
                ProjectionY[pu][d]->GetXaxis()->SetRangeUser(0, 100);
                ProjectionY[pu][d]->GetYaxis()->SetRangeUser(0, 100000);
      		ProjectionY[pu][d]->Draw();
      		char *Projection11 = new char[12];
      		Int_t pro = pu * 8 + d + 1;
      		sprintf(Projection11,"Projection3x_%d.gif",pro);
      		cout<<"=========================="<<Projection11<<endl;
      		c16->Print(outputpath + Projection11);
      		c16->Clear();
	        ...
	        TCanvas *c17 = new TCanvas();
      		...
      		sprintf(hist2Dname11,"histoss2D_%d.gif",pud);
      		cout<<"=========================="<<hist2Dname11<<endl;
      		c17->Print(outputpath + hist2Dname11);
      		c17->Clear();
                
                TCanvas *c18 = new TCanvas();
            	c18->cd();
                ProjectionY[pu][d]->GetXaxis()->SetRangeUser(0, 1500);
                ProjectionY[pu][d]->GetYaxis()->SetRangeUser(0, 1400);
      		ProjectionY[pu][d]->Draw();
      		char *Projection1 = new char[12];
      		Int_t pro = pu * 8 + d + 1;
      		sprintf(Projection1,"Projection3x_%d.gif",pro);
      		cout<<"=========================="<<Projection1<<endl;
      		c18->Print(outputpath + Projection1);
      		c18->Clear();
		...
		TCanvas *c19 = new TCanvas();
            	c19->cd();
                ProjectionY[d][r]->SetLineColor(r+1);
                ProjectionY[d][r]->GetXaxis()->SetRangeUser(0, 300);
               	ProjectionY[d][r]->Draw("same");
		ProjectionY[d][1]->SetLineColor(2);
                ProjectionY[d][1]->GetXaxis()->SetRangeUser(0, 300);
               	ProjectionY[d][1]->Draw("same");
                ProjectionY[d][2]->SetLineColor(3);
                ProjectionY[d][2]->GetXaxis()->SetRangeUser(0, 300);
               	ProjectionY[d][2]->Draw("same");
		ProjectionY[d][3]->SetLineColor(4);
                ProjectionY[d][3]->GetXaxis()->SetRangeUser(0, 300);
               	ProjectionY[d][3]->Draw("same");
		ProjectionY[d][4]->SetLineColor(5);
                ProjectionY[d][4]->GetXaxis()->SetRangeUser(0, 300);
               	ProjectionY[d][4]->Draw("same");
                
		auto legend = new TLegend(0.7,0.7,0.88,0.88);
		legend->AddEntry(ProjectionY[d][0],"Ring 1", "l");
                legend->AddEntry(ProjectionY[d][1],"Ring 2", "l");
		legend->AddEntry(ProjectionY[d][2],"Ring 3", "l");
		legend->AddEntry(ProjectionY[d][3],"Ring 4", "l");
		legend->AddEntry(ProjectionY[d][4],"Ring 5", "l");
		...
		char *Projection1 = new char[10];
      		Int_t pro1 = pu * 8 + d + 1;
      		sprintf(Projection1,"Projections3x_%d.gif",pro1);
      		cout<<"=========================="<<Projection1<<endl;
      		c19->Print(outputpath + Projection1);
      		c19->Clear();
		...
		char *Projection11 = new char[10];
      		Int_t pro11 = pu * 8 + d + 1;
      		sprintf(Projection11,"Projectionss3x_%d.gif",pro11);
      		cout<<"=========================="<<Projection11<<endl;
      		c20->Print(outputpath + Projection11);
      		c20->Clear();
            	...
            	c21->cd();
                c21->SetLogy();
                ProjectionY[pu][r]->SetLineColor(r);
                ProjectionY[pu][r]->SetMinimum(0);
                ProjectionY[pu][r]->GetXaxis()->SetRangeUser(0, 50);
               
               	ProjectionY[pu][r]->Draw("same");
                ProjectionY[pu][r]->SetLineColor(r);
		

		auto legend1 = new TLegend(0.7,0.7,0.88,0.88);
		legend1->AddEntry(ProjectionY[pu][r], "pu = " ,"l");

		char *Projection12 = new char[10];
      		Int_t pro12 = pu * 8 + d + 1;
      		sprintf(Projection12,"Projectionsss3x_%d.gif",pro12);
      		cout<<"=========================="<<Projection12<<endl;
      		c21->Print(outputpath + Projection12);
      		c21->Clear();
