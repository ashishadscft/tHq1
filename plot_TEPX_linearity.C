void plot_TEPX_linearity() {
  ...
  for (int pu = 0; pu < pulist.size(); pu++) {
	...
	if(pu < 4){
	  ...
	  c5->Print(outputpath + Projection11);
	  c5->Clear();
	  ...
	  c6->Print(outputpath + Projection14);
	  c6->Clear();
	  ...
	  c7->Print(outputpath + Projection15);
	  c7->Clear();
	  ...
	  c9->Print(outputpath + Projection17);
	  c9->Clear();
	...
	c10->Print(outputpath + Projection12);
	c10->Clear();
	...
	cout<<"=========================="<<Projection14<<endl;
	c11->Print(outputpath + Projection14);
	c11->Clear();
	...
	cout<<"=========================="<<Projection15<<endl;
	c12->Print(outputpath + Projection15);
	c12->Clear();
	...
	cout<<"=========================="<<Projection16<<endl;
	c13->Print(outputpath + Projection16);
	c13->Clear();
	...
	cout<<"=========================="<<Projection17<<endl;
	c14->Print(outputpath + Projection17);
	c14->Clear();
      }
	...
	if (pu < 4){
	  ...
	  cout<<"=========================="<<hist2Dname<<endl;
	  c15->Print(outputpath + hist2Dname);
	  c15->Clear();
	  ...
	  cout<<"=========================="<<Projection<<endl;
	  c16->Print(outputpath + Projection);
	  c16->Clear();
	...
	if (pu >= 4){
	  ...
	  cout<<"=========================="<<hist2Dname<<endl;
	  c17->Print(outputpath + hist2Dname);
	  c17->Clear();
	  ...
	  sprintf(Projection,"Projection2x_%d.gif",pro);
	  cout<<"=========================="<<Projection<<endl;
	  c18->Print(outputpath + Projection);
	  c18->Clear();
	...
	if(pu < 4){
	  ...
	  cout<<"=========================="<<Projection11<<endl;
	  c19->Print(outputpath + Projection11);
	  c19->Clear();
	  ...
	  cout<<"=========================="<<Projection14<<endl;
	  c20->Print(outputpath + Projection14);
	  c20->Clear();
	  ...
	  cout<<"=========================="<<Projection15<<endl;
	  c21->Print(outputpath + Projection15);
	  c21->Clear();
	  ...
	  cout<<"=========================="<<Projection16<<endl;
	  c22->Print(outputpath + Projection16);
	  c22->Clear();
	  ...
	  cout<<"=========================="<<Projection17<<endl;
	  c23->Print(outputpath + Projection17);
	  c23->Clear();
	...
	cout<<"=========================="<<Projection12<<endl;
	c24->Print(outputpath + Projection12);
	c24->Clear();
	...
	cout<<"=========================="<<Projection14<<endl;
	c25->Print(outputpath + Projection14);
	c25->Clear();
	...
	cout<<"=========================="<<Projection15<<endl;
	c26->Print(outputpath + Projection15);
	c26->Clear();
	...
	cout<<"=========================="<<Projection16<<endl;
	c27->Print(outputpath + Projection16);
	c27->Clear();
	...
	cout<<"=========================="<<Projection17<<endl;
	c28->Print(outputpath + Projection17);
	c28->Clear();
      }
	...
	if (pu < 4){
	  ...
	  cout<<"=========================="<<hist2Dname<<endl;
	  c29->Print(outputpath + hist2Dname);
	  c29->Clear();
	  ...
	  //legend25->AddEntry(ProjectionY[pu][d], "Ring 1" ,"l");
	  ...
	  cout<<"=========================="<<Projection<<endl;
	  c30->Print(outputpath + Projection);
	  c30->Clear();
	...
	if (pu >= 4){
	  ...
	  cout<<"=========================="<<hist2Dname<<endl;
	  c31->Print(outputpath + hist2Dname);
	  c31->Clear();
	  ...
	  //legend26->AddEntry(ProjectionY[pu][d], "Ring 1" ,"l");
	  ...
	  sprintf(Projection,"Projection3x_%d.gif",pro);
	  cout<<"=========================="<<Projection<<endl;
	  c32->Print(outputpath + Projection);
	  c32->Clear();
	...
	if(pu < 4){
	  ...
	  cout<<"=========================="<<Projection11<<endl;
	  c33->Print(outputpath + Projection11);
	  c33->Clear();
	  ...
	  cout<<"=========================="<<Projection14<<endl;
	  c34->Print(outputpath + Projection14);
	  c34->Clear();
	  ...
	  cout<<"=========================="<<Projection15<<endl;
	  c35->Print(outputpath + Projection15);
	  c35->Clear();
	  ...
	  cout<<"=========================="<<Projection16<<endl;
	  c36->Print(outputpath + Projection16);
	  c36->Clear();
	  ...
	  cout<<"=========================="<<Projection17<<endl;
	  c37->Print(outputpath + Projection17);
	  c37->Clear();
	...
	cout<<"=========================="<<Projection12<<endl;
	c38->Print(outputpath + Projection12);
	c38->Clear();
	...
	cout<<"=========================="<<Projection14<<endl;
	c39->Print(outputpath + Projection14);
	c39->Clear();
	...
	cout<<"=========================="<<Projection15<<endl;
	c40->Print(outputpath + Projection15);
	c40->Clear();
	...
	cout<<"=========================="<<Projection16<<endl;
	c41->Print(outputpath + Projection16);
	c41->Clear();
	...
	cout<<"=========================="<<Projection17<<endl;
	c42->Print(outputpath + Projection17);
	c42->Clear();
