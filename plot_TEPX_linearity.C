  ...
  for (int pu = 0; pu < pulist.size(); pu++) {
	...
	if(pu < 4){
	  ...
	  ProjectionY[0][d]->GetXaxis()->SetRangeUser(0, 100);
          ProjectionY[0][d]->GetYaxis()->SetTitle("# of events");
	  ...
	  ProjectionY1[0][d]->GetYaxis()->SetTitle("# of events");
	  ...
	  ProjectionY2[0][d]->GetXaxis()->SetRangeUser(0, 100);
          ProjectionY2[0][d]->GetYaxis()->SetTitle("# of events");
	...
	if (pu >= 4){
	  ...
	  cout<<"=========================="<<hist2Dname<<endl;
	  c31->Print(outputpath12 + hist2Dname);
	  c31->Clear();
