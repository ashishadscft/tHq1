void plot_TEPX_linearity() {
    ...
    for (long d = 0; d < disklist.size(); d++)
        for (long r = 0; r < 5; r++) {
            ...
            TEPXClustersPerEvent[d][r]->GetYaxis()->SetRangeUser(0, 2);
    ...
    NonLinearity_TEPXClustersPerEvent[3][0]->GetYaxis()->SetLabelSize(0.03);
    ...
    NonLinearity_TEPXClustersPerEvent[3][0]->SetMarkerSize(0.6);
    NonLinearity_TEPXClustersPerEvent[3][0]->SetTitle("Disk 4 Ring 1");
    TLine* line1 = new TLine(0, 0, 4, 0);
